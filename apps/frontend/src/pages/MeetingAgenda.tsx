  ...
  return (
    <div className="min-h-screen bg-white font-helvetica">
      <PageBanner
        ...
        subtitle="Agendas for MCZMA meetings — browse by date or meeting number"
      />
      ...
      <section className="w-full flex justify-center pb-16 bg-white">
        <div className="w-full max-w-[1100px] px-4 flex flex-col gap-6">
          ...
          <p className="text-[13px] text-gray-400 -mt-2">
            Showing {Math.min(paginated.length, PAGE_SIZE)} of {filtered.length} records
            {(appliedDate || appliedMeeting) && (
